  ...
  "Condition": {
    "StringLike": {
      "token.actions.githubusercontent.com:sub": [
        "repo:YOUR_GITHUB_ORG/techitfactory-infra:ref:refs/heads/main",
        "repo:YOUR_GITHUB_ORG/techitfactory-infra:environment:dev"
      ]
    }
  }
}
...
```json
{
  "Condition": {
    "StringLike": {
      "token.actions.githubusercontent.com:sub": [
        "repo:YOUR_GITHUB_ORG/techitfactory-infra:environment:prod"
      ]
    }
  }
}
