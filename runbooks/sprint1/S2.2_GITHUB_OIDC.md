...
## Story Summary
Configure GitHub Actions to authenticate with AWS using OIDC (OpenID Connect) — no static AWS keys needed.
...
gh secret set AWS_ROLE_ARN --body "$ROLE_ARN" --repo YOUR_GITHUB_ORG/techitfactory-infra
