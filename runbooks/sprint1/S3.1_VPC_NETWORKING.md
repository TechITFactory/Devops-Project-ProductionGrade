...
### Step 2.1: Configure Backend (if not done)
```bash
...
### Step 2.2: Update environments/dev/main.tf
```bash
cd ~/Desktop/Devops-Project/techitfactory-infra/environments/dev

# Update the main.tf to enable VPC module
# Uncomment the backend and VPC module blocks
# Replace <bucket-name> and <table-name> with actual values
```
