...
```
1. Go to: https://github.com/YOUR_GITHUB_ORG/techitfactory-infra/settings/branches
...
4. Enable:
   ...
   ⚠️ FOR SOLO DEVELOPERS/COURSE:
   ❌ UNCHECK "Do not allow bypassing the above settings"
   (This allows admins to merge their own PRs)
...
```
1. Go to: https://github.com/YOUR_GITHUB_ORG/techitfactory-app/settings/branches
2. Click "Add branch protection rule"
3. Branch name pattern: main
4. Enable:
   ✅ Require a pull request before merging
...
```
1. Go to: https://github.com/YOUR_GITHUB_ORG/techitfactory-gitops/settings/branches
2. Click "Add branch protection rule"
3. Branch name pattern: main
4. Enable:
   ✅ Require a pull request before merging
...
```bash
# Using GitHub CLI
gh api repos/YOUR_GITHUB_ORG/techitfactory-infra/branches/main/protection
