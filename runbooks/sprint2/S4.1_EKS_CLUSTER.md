...
> **⏱️ Time:** EKS cluster creation takes ~15-20 minutes.
> **💰 Cost:** ~$147/month (control plane $72 + nodes $60 + EBS $10 + logs $5)
...
│  │  ┌─────────┐  ┌─────────┐                                     │  │
│  │  │t3.medium│  │t3.medium│  ← Auto-scaled by Cluster Autoscaler│  │
│  │  │ Node 1  │  │ Node 2  │                                     │  │
│  │  └─────────┘  └─────────┘                                     │  │
│  └──────────────────────────────────────────────────────────────┘  │
│                                                                     │
│  Add-ons: EBS CSI | CoreDNS | kube-proxy | VPC CNI                 │
│  IRSA Roles: Cluster Autoscaler | ALB Controller | EBS CSI         │
└────────────────────────────────────────────────────────────────────┘
```
...
> **✅ The EKS module code is already complete in the repo!**
...
# ☕ Go get coffee - EKS takes 15-20 minutes
```
...
| 2x t3.medium nodes | ~$60 | $0.0416/hour × 2 × 720 hours |
| EBS (50GB × 2) | ~$10 | $0.10/GB-month |
