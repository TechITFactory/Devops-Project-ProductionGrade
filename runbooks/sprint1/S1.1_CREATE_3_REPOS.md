...
git clone https://github.com/YOUR_GITHUB_ORG/techitfactory-infra.git
...
* @YOUR_GITHUB_ORG/infra-team

# Security review for IAM changes
modules/*/iam*.tf @YOUR_GITHUB_ORG/security-team
bootstrap/ @YOUR_GITHUB_ORG/security-team
EOF
```
...
```bash
cd ..
git clone https://github.com/YOUR_GITHUB_ORG/techitfactory-app.git
...
services/ @YOUR_GITHUB_ORG/app-team

# Platform team owns Helm charts
charts/ @YOUR_GITHUB_ORG/platform-team
EOF
```
...
```bash
cd ..
git clone https://github.com/YOUR_GITHUB_ORG/techitfactory-gitops.git
...
apps/platform/ @YOUR_GITHUB_ORG/platform-team

# App team can update service releases
apps/services/ @YOUR_GITHUB_ORG/app-team

# Prod requires additional review
environments/prod/ @YOUR_GITHUB_ORG/platform-team @YOUR_GITHUB_ORG/leads
EOF
```
...
spec:
  project: default
  source:
    repoURL: https://github.com/YOUR_GITHUB_ORG/techitfactory-gitops.git
    targetRevision: main
    path: apps
  destination:
